  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 40),
        Text('company: SpaceX' , style: TextStyles.font22RegularWhite,),
        const SizedBox(height: 30),
        Text('Type: rocket' , style: TextStyles.font22RegularWhite,),
        const SizedBox(height: 30),
        Text('country: United States' , style: TextStyles.font22RegularWhite,),
        const SizedBox(height: 30),
        Text('first_flight: 2010-06-04' , style: TextStyles.font22RegularWhite,),
        const SizedBox(height: 30),
        Text('cost_per_launch: 50000000' , style: TextStyles.font22RegularWhite,),
        const SizedBox(height: 30),
      ],
    );
  }
