...
class _WebServices implements WebServices {
  ...
  Future<List<Dragon>> getAllDragons() async {
    ...
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<Dragon>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => Dragon.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  @override
  Future<List<LaunchesResponse>> getAllLaunches() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<LaunchesResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map(
            (dynamic i) => LaunchesResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
